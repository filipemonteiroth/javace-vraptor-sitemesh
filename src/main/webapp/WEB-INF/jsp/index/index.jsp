...
<html lang="en">
  <head>
    ...
    <title>SiteMesh - JavaCE</title>
	<link href="<c:url value='/css/bootstrap.min.css'/>" media="screen" rel="stylesheet" />
	<link href="<c:url value='/css/carousel.css'/>" media="screen" rel="stylesheet" />
  </head>
  <body>
        ...
        <div class="navbar navbar-inverse navbar-static-top">
          <div class="container">
            <div class="navbar-header">
              ...
              <a class="navbar-brand" href="#">JavaCE - SiteMesh</a>
            </div>
            <div class="navbar-collapse collapse">
              <ul class="nav navbar-nav">
                <li class="active"><a href="#">Home</a></li>
                <li><a href="<c:url value="/admin/inicio"/>">Administração</a></li>
                <li><a href="<c:url value="/user/inicio"/>">Usuário</a></li>                
              </ul>
            </div>
          </div>
        </div>
    ...
    <script src="<c:url value="/javascript/holder.js"/>"></script>
  </body>
</html>